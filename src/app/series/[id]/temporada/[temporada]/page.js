    ...
    return (
        <Pagina titulo={temporada.name}>
            ...
            <Modal show={show} onHide={()=>setShow(false)}>
                ...
                <Modal.Body>
                    <div>
                        <img className="img-fluid" src={'https://image.tmdb.org/t/p/w500/' + episodio.still_path} />
                        <p><b>Episódio: </b> {episodio.episodio_number}</p>
                        <p><b>Duração: </b> {episodio.runtime}</p>
